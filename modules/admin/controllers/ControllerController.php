...
class ControllerController extends ControllerAdmin
{
	...
	{
		$model = new AppController();	  
	    $dataOptions = App::getModuleControllerAssoc($_POST['moduleCode']);	    
	    
		echo Html::activeDropDownList($model, 'controllerName',$dataOptions,['class'=>'form-control', 'prompt'=>'==Select==']) ;
	}
}
