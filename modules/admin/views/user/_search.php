...
/* @var $model app\modules\admin\models\UserMasterSearch */
...
<div class="user-master-search">
    ...
    <?php // echo $form->field($model, 'profileCreatedFor') ?>

    <?php // echo $form->field($model, 'bodyType') ?>

    <?php // echo $form->field($model, 'height') ?>

    <?php // echo $form->field($model, 'age') ?>

    <?php // echo $form->field($model, 'physicalStatus') ?>
